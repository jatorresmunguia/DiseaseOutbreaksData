...
#### Description: 
Dataset containing 2227 observations (unique disease outbreaks), occurred in a total of 233 countries and territories from 1996, and associated to 70 different infectious diseases. A unique outbreak happens when a country has at least one case of a specific disease during a particular year. 
#### Data records:
"Country": Name of the country where the outbreak occurred.
